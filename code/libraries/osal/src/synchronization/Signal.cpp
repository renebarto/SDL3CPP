...
template<>
const serialization::BidirectionalMap<osal::SignalType, std::string> EnumSerializationMap<osal::SignalType>::ConversionMap =
{
    { osal::SignalType::None, "None" },
    { osal::SignalType::Interrupt, "Interrupt" },
    { osal::SignalType::Illegal, "Illegal" },
    { osal::SignalType::FPError, "FPError" },
    { osal::SignalType::SegmentViolation, "SegmentViolation" },
    { osal::SignalType::Terminate, "Terminate" },
    { osal::SignalType::Abort, "Abort" },
};
...
std::ostream& operator << (std::ostream& stream, const SignalType& value)
{
